...
RCT_EXTERN_METHOD(downloadStream:(NSString *)url downloadID:(NSString *)downloadID title:(NSString *)title assetArtworkURL:(NSString *)assetArtworkURL)
RCT_EXTERN_METHOD(downloadStreamWithBitRate:(NSString *)url downloadID:(NSString *)downloadID title:(NSString *)title assetArtworkURL:(NSString *)assetArtworkURL bitRate:(nonnull NSNumber *)bitRate)

...
class ReactMediaPlayerView extends FrameLayout implements
    ...
    public void onPlayerError(ExoPlaybackException e) {
        ...
        if (e.type == ExoPlaybackException.TYPE_RENDERER) {
            ...
            errorString = "Unrecognized Format";
        }
        if (errorString != null) {
    ...
    public void setSelectedTextTrack(String type, Dynamic value) {
        ...
        DefaultTrackSelector.SelectionOverride selectionOverride = new DefaultTrackSelector.SelectionOverride(index, trackIndex);
        trackSelector.setParameters(
                trackSelector
                        .buildUponParameters()
                        .setSelectionOverride(index, groups, selectionOverride));
    }
